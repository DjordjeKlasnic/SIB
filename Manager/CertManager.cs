...
namespace Manager
{
    public class CertManager
    {
        ...
        public static X509Certificate2 GetCertificateFromStorage(StoreName storeName, StoreLocation storeLocation, string subjectName, string subjectGroup)
        {
            ...
            {
                if (c.SubjectName.Name.Equals(string.Format("CN={0}, OU={1}", subjectName, subjectGroup)))
                {
                    return c;
                }
            }
